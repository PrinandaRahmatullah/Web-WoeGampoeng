<?php
  ...
  $kode = $_GET['kode'];
  $query = $conn->query("SELECT * FROM hargatravello where kode = '$kode'");
...
<html lang="en">
    <head>
        ...
        <title>Ubah Tarif Travello</title>
    </head>
    <body>
    <?php include_once "nav.php" ?>

        <div class="container">
            <h4>Ubah Tarif Travello</h4>
            <form action="act_ubah_hiace.php" method="POST">
