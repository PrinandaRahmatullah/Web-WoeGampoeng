<?php
  ...
  $kode = $_GET['kode'];
  $query = $conn->query("SELECT * FROM hargahiace where kode = '$kode'");
...
<html lang="en">
    <head>
        ...
        <title>Ubah Tarif Hiace</title>
    </head>
    <body>
        <?php include_once "nav.php" ?>
        <div class="container">
            <form action="action/act_ubah_hiace.php" method="POST">
            <h4>Ubah Tarif Hiace</h4>
